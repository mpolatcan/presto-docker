...
load_config "node-scheduler.network-topology.segments" ${NODE_SCHEDULER_NETWORK_TOPOLOGY_SEGMENTS:=machine} "config.properties"
load_config "node-scheduler.network-topology.type" ${NODE_SCHEDULER_NETWORK_TOPOLOGY_TYPE:=flat} "config.properties"
load_config "node-scheduler.network-topology.file" ${NODE_SCHEDULER_NETWORK_TOPOLOGY_FILE:=NULL} "config.properties"
load_config "node-scheduler.network-topology.refresh-period" ${NODE_SCHEDULER_NETWORK_TOPOLOGY_REFRESH_PERIOD:=5m} "config.properties"
...
load_config "task.http-timeout-threadsd" ${TASK_HTTP_TIMEOUT_THREADSD:=3} "config.properties"
...
load_config "optimizer.max-reordered-join" ${OPTIMIZER_MAX_REORDERED_JOIN:=9} "config.properties"
