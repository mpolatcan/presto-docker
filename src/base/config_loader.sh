...
load_config "http-server.log.max-size" ${HTTP_SERVER_LOG_MAX_SIZE:=unlimited} "config.properties"
...
load_config "optimizer.push-aggregation-through-join" ${OPTIMIZER_PUSH_AGGREGATION_THROUGH_JOIN:=true} "config.properties"
